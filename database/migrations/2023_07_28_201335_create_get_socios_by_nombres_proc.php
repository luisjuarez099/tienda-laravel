...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("CREATE DEFINER=`equipo1`@`%` PROCEDURE `get_socios_by_nombres`(IN nombres VARCHAR(65))
BEGIN
SELECT 
    s.idSocios AS ID,
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS get_socios_by_nombres");
    }
};
